...
route('GET /api/0.6/changesets', require('./changesets.js'))
route('PUT /api/0.6/:type(observation|node|way|relation)/:id', require('./element_create.js'))
route('GET /api/0.6/:type(observation|node|way|relation)/:id/history', require('./element_history.js'))
route('GET /api/0.6/:type(observation|node|way|relation)/:id/:version', require('./element_version.js'))
route('GET /api/0.6/:type(nodes|ways|relations)', require('./element_multi_fetch.js'))
route('GET /api/0.6/:type(observation|node|way|relation)/:id', require('./element_read.js'))
route('DELETE /api/0.6/:type(observation|node|way|relation)/:id', require('./element_delete'))
